...
XCVAR_DEF( g_forcePowerDisable,			"245759",		NULL,				CVAR_SERVERINFO|CVAR_ARCHIVE|CVAR_LATCH,		qtrue )
...
XCVAR_DEF( g_gametype,					"6",			NULL,				CVAR_SERVERINFO|CVAR_INIT,						qfalse )
...
XCVAR_DEF( tm_barrelDensity,			"25",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( tm_AdminPass,				"password",		NULL,				CVAR_NONE,										qfalse )
XCVAR_DEF( tm_debugAllowJoin,			"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( tm_debugForceTeam,			"0",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( tm_reloadSpeed,				"1500",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( tm_rounds,					"5",			NULL,				CVAR_ARCHIVE,									qfalse )
XCVAR_DEF( tm_barrelModelMode,			"2",			NULL,				CVAR_ARCHIVE,									qfalse )
